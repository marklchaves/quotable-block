 ...
 * @since 1.0.0
 */
function quotable_block_cgb_block_assets() { // phpcs:ignore
	// Register block styles for both frontend + backend.
	wp_register_style(
		'quotable_block-cgb-style-css', // Handle.
	...
	wp_register_script(
		'quotable_block-cgb-block-js', // Handle.
	...
	wp_register_style(
		'quotable_block-cgb-block-editor-css', // Handle.
	 ...
	 */
	register_block_type(
		'cgb/block-quotable-block', array(
			// Enqueue blocks.style.build.css on both frontend & backend.
			'style'         => 'quotable_block-cgb-style-css',
			// Enqueue blocks.build.js in the editor only.
			'editor_script' => 'quotable_block-cgb-block-js',
			// Enqueue blocks.editor.build.css in the editor only.
			'editor_style'  => 'quotable_block-cgb-block-editor-css',
		)
	);
}

// Hook: Block assets.
add_action( 'init', 'quotable_block_cgb_block_assets' );
